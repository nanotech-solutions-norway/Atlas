# Atlas AI Security Report Source Manifest — 21:38, 27.07.2026

**Project:** Atlas Website / Atlas AI  
**Classification:** `EVIDENCE_ONLY`; integrity and ingestion controls `AUTO_APPROVED`  
**Release effect:** None; `NO_GO` remains controlling.
...
The report is research evidence, not proof that Atlas controls are implemented, tested, certified or release-approved. Findings become governing only through separately classified Atlas decisions, active-source updates, controls and acceptance gates.

## Source limitations

1. The research session could not retrieve the named Atlas GitHub and Drive records. Current controlled ingestion did retrieve them and supersedes report maturity assumptions based on no internal evidence.
...
The following are controlled reconstructions derived from the report and current Atlas sources, not byte-identical copies of the missing companion files:

- `../ATLAS_SECURITY_CONTROL_CATALOGUE_2355_27072026.csv`
- `../ATLAS_SECURITY_IMPLEMENTATION_ROADMAP_2355_27072026.csv`
