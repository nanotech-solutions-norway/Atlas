...
| ATL-ERR-20260726-011 | The generated 20:37 consumer-law report was not stored in canonical GitHub or the controlled Drive legal folder. | Research output ingestion was omitted after generation. | Exact review, citation audit and controlled `RESEARCH_COMPLETED` status cannot be established. | Require artifact ingestion, stable version/checksum, line-by-line review and readback before status promotion. | GitHub and Drive searches, 26.07.2026. | Open evidence blocker. | `AUTO_APPROVED` |
| ATL-ERR-20260726-012 | The Drive decisions mirror contained duplicated/stale decision IDs compared with canonical GitHub. | Mirror updates were appended or copied without complete canonical replacement. | Users could read conflicting governance states. | Replace the Drive mirror from the canonical GitHub file and verify readback after each governance update. | GitHub/Drive comparison, 26.07.2026. | Corrected in this workstream; readback required. | `AUTO_APPROVED` |
