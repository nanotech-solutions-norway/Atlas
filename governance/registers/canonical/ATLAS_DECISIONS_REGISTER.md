...
|---|---|---|---|
| ATL-DEC-20260725-010 | Public prices, MVA treatment, provider-delivery rights, plan allowances, Family conditions, legal interpretation, production routing and Managed Secure activation were collectively unresolved. | Prices/commercial controls are governed by ATL-DEC-20260725-011–014; MVA by 015–016; consumer-law/checkout by 017–018. | `SUPERSEDED` |
| ATL-DEC-20260726-021 | Proposed lowest-risk scope required an adult contract holder only and excluded all minors. | ATL-DEC-20260726-025 and the v0.6.1 professional-pack amendment: Student plans may start at 16 only through a counsel-approved controlled model; under-16/Family remain excluded. | `SUPERSEDED` |
