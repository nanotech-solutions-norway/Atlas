...
| ATL-DEC-20260726-021 | 26.07.2026 | Proposed lowest-risk initial consumer scope is Norway-only, monthly Student Basic, Student Plus and Everyday Basic, adult contract holder only, with Family, minors, annual, semester, paid top-ups and foreign B2C excluded. | Professional review and launch-scope planning | Reduces unresolved legal, tax, identity and refund paths; exact recommendation recorded in the professional decision pack. | Project owner | Professional advice and explicit launch-scope approval | `PENDING_REVIEW` |
