...
| ATL-VAL-20260726-035 | 26.07.2026 | Original 20:37 consumer-law report artifact integrity | SHA-256, file-size, exact heading-hierarchy and normalized token-sequence comparison | `PASS_CONTENT_EQUIVALENCE_NOT_BYTE_EQUIVALENCE` | DOCX/Markdown checksums; 29/29 headings; 0.963915 similarity | Preserve raw source and controlled reconciliation | `AUTO_APPROVED` |
| ATL-VAL-20260726-036 | 26.07.2026 | Original 13:01 pricing report artifact integrity | SHA-256, file-size, exact heading-hierarchy and normalized token-sequence comparison | `PASS_CONTENT_EQUIVALENCE_NOT_BYTE_EQUIVALENCE` | DOCX/Markdown checksums; 27/27 headings; 0.976388 similarity | Preserve raw source and trigger-based economic refresh | `AUTO_APPROVED` |
| ATL-VAL-20260726-037 | 26.07.2026 | Original consumer-law report primary-source reconciliation | Current Lovdata, CJEU and official Wix review | `PASS_CORE_REQUIREMENTS / PARTIAL_ATLAS_APPLICATION` | Original-report validation and reconciliation | Norwegian counsel approves exact classifications/copy/formulas | `AUTO_APPROVED` |
| ATL-VAL-20260726-038 | 26.07.2026 | Raw report citation portability | Inspection of citation markers in supplied Markdown/DOCX | `FAIL_ARCHIVAL_PORTABILITY / MITIGATED` | Conversation-local `turn...` tokens do not resolve as stable external sources; separate source reconciliation created | Future reports must include persistent source bibliography | `AUTO_APPROVED` |
| ATL-VAL-20260726-039 | 26.07.2026 | Original-report ingestion effect on release locks | Phase 0.5 and readiness-file readback | `PASS_NO_RELEASE_EFFECT` | All public/purchase/checkout/plan/immediate-activation locks remain false | Maintain until professional, implementation, test and release approval | `AUTO_APPROVED` |
